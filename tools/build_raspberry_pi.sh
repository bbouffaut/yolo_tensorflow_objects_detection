...
# echo 'deb [arch=armhf] http://ports.ubuntu.com/ artful main restricted universe multiverse' >> /etc/apt/sources.list.d/armhf.list
# echo 'deb [arch=armhf] http://ports.ubuntu.com/ artful-updates main restricted universe multiverse' >> /etc/apt/sources.list.d/armhf.list
# echo 'deb [arch=armhf] http://ports.ubuntu.com/ artful-security main restricted universe multiverse' >> /etc/apt/sources.list.d/armhf.list
# echo 'deb [arch=armhf] http://ports.ubuntu.com/ artful-backports main restricted universe multiverse' >> /etc/apt/sources.list.d/armhf.list
# sed -i 's#deb http://fr.archive.ubuntu.com/ubuntu/#deb [arch=amd64] http://fr.archive.ubuntu.com/ubuntu/#g' /etc/apt/sources.list
# apt-get update
