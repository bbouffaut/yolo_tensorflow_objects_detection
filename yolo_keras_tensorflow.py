...
class ProcessedImage:
    ...
    def write_annotated_image(self, target_filename, classes):
        ...
        self.draw_boxes.draw_boxes(self.cv_im, self.objects, classes)
...
class YoloKerasTF:
    ...
    def __init__(self):
        ...
        self.draw_boxes = self.yolo_predict.draw_boxes
        ...
        if not cv_im is None:
            ...
            if module_cfg.DEBUG:
                print ('Detection took {:.3f}s for '
                    '{:d} object proposals').format(processing_time, vis_objects.size)
